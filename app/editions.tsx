const editions = [
  {
    ...
    authorBio: "María Magdalena es poeta y escritora argentina. Su obra se caracteriza por una escritura disruptiva que desacomoda las formas hasta encontrar un canto singular.",
  ...
  },
  {
    ...
    authorBio: "María Malusardi es poeta, narradora y ensayista argentina. Ha publicado numerosos libros de poesía y su obra ha sido reconocida con diversos premios literarios.",
    review: `El lenguaje permite lo imposible. El yo asiste a su funeral y sostiene la voz. En la ceremonia, los verbos sacan las mortajas al sol y cantan. El futuro es puro lenguaje: está hecho de acciones que se lanzan hacia adelante como serpentinas de deseo, furia o dolor. La vida después es un estribillo que repiquetea en los días por venir. En el entierro de la obra, el poema labra el testamento, y también ríe y baila sobre su tumba. Es imposible no hacerse la película. La sábana del lecho es la pantalla en la que pasará la vida: ojos, roces, harapos, huellas, hijos. Un campanario y los zapatos. ¿Qué harán con la desnudez y la soledad? ¿Adónde irán las esquinas y las lápidas?
        Con voz acicalada de humor y finitud, María Malusardi nos acerca a los efectos secundarios de la muerte y ofrece —para quienes no sabemos morir ni rezar— un conjunto de poemas sobre esa loca fantasía del final.`,
  ...
  },
  {
    ...
    authorBio: "Diego Roel es poeta argentino. Su obra explora el desamparo existencial y la búsqueda del padre simbólico a través de una lírica profunda y épica.",
  ...
  },
  {
    ...
    authorBio: "Enzo Amarillo es poeta y editor argentino. Su escritura se caracteriza por el contraste entre el lirismo y la desgarradura, explorando la soledad y el deseo.",
    ...
    Una voz narra desanimándose, montada sobre un lenguaje fértil y movedizo. El tono de cada uno de estos poemas en prosa mantiene la potencia y la sensualidad brutal que despide el epígrafe de Susana Villalba, tan bien elegido, tan atinado para restaurar la confusión de una trama que, de tan espesa, ahoga. No porque haya maraña, sino porque duele tiernamente tan grosero abandono, tan humillante condición sumida en la belleza del más armonioso devenir poético: "Es divina esta peste. Este basural codiciado."
...
`,
  ...
  },
  {
    ...
    authorBio: "Carmen García Palma es poeta chilena. Su escritura se entrega sin reservas a la palabra, dejando que los sueños sean poemas y los cuentos sean sueños.",
    review: `En este libro hay una mujer rodeada de sombras y voces asediantes, quizás sea el primer vertebrado en pisar tierra firme. Vive en una isla que es un templo donde todo muta y murmura, donde el sueño es un portal. Pero debe partir.
    El viaje la lleva a una ciudad que arde, donde las estaciones pasan como las voces de los hombres y las palabras se vuelven fríos monumentos sin razón.
    Tiene cien años y desde niña sabe que el mayor placer es desaparecer. La ciudad hace posible ese acto de magia, pero trae consigo el paso de la inocencia al conocimiento. Un día desde un muelle divisa la isla dormida, su hogar, la promesa de los amaneceres multiplicados hasta el infinito.
    Carmen García Palma escribió Máquina para hablar con los muertos entregándose sin reservas a la palabra, dejando que los sueños sean poemas y los cuentos sean sueños.`,
