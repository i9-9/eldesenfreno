    ...
    },
    {
        ...
        description: (
            <>
                ...
                edición realizada en Ecuador y editorial Buenos Aires Poetry, 2017), <i>El sastre</i>
                (Ediciones en Danza, 2015), <i>Artista del trapecio</i> (Alción, 2014), <i>La música</i> (El suri
                porfiado, 2013), <i>El orfanato</i> (Alción, 2010), <i>Trilogía de la tristeza</i> (Alción, 2009),
                <i>Museo de postales</i> (El suri porfiado, 2008), <i>Diálogo con pescadores</i> (Alción, 2007),
                <i>Variaciones en la niebla</i> (Alción, 2005), <i>La carta de vermeer</i> (Alción, 2002) y <i>El
                accidente</i> (Mascaró, 2001).
                <br /><br />Obtuvo por <i>El sastre</i>, la Mención especial del Premio de Literatura Casa de las
                Américas 2015, de Cuba. Y por <i>Artista del hambre</i> el Segundo Premio Municipal de
                Poesía 2018-2019. Y <i>Trilogía de la tristeza</i> resultó finalista del Concurso Olga
                Orozco 2009 que organizó la Universidad de San Martín, con un jurado integrado
                por Antonio Gamoneda, Gonzalo Rojas, Juan Gelman y Jorge Boccanera; además
                fue traducido al francés y editado en 2013 como <i>Trilogie de la tristesse</i> (Zinnia
                Editions), tanto en papel como en formato e-book.
                <br /><br /> Recibió en 2018 la beca del Fondo Nacional de las Artes para escribir <i>Asamblea
                permanente. Diálogos para una hermenéutica</i>, un ensayo sobre la obra y vida del
                poeta argentino Alberto Szpunberg.
                <br /><br />Estuvo a cargo de la edición y estudio preliminar de la poesía de Raúl Gustavo
                Aguirre en el volumen <i>Obra poética</i> (Ediciones Del dock, 2015) y del ensayo <i>Las
                poéticas del siglo XX</i> (Audisea, 2016). 
                <br /><br /><i>Nadie sabe qué hacer con los poetas</i>, próximamente editado por Llantén, reúne sus
                escritos sobre poesía, publicados e inéditos.
            </>
        ),
        link: ''
    },
