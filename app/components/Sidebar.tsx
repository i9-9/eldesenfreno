...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`bg-[#0b0b0b] text-white fixed hidden md:block h-screen transition-all duration-300 ease-in-out z-40 ${
          ...
          <div className="flex flex-col flex-1 min-h-0 border border-white border-opacity-20 rounded-lg backdrop-blur-lg shadow-lg bg-[#2C2C2C] bg-opacity-10 overflow-hidden">
            ...
            <div className="shrink-0 px-3 pb-3 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2 p-2 w-full justify-center bg-[#2C2C2C] hover:bg-gray-400 text-white text-xs font-neue-display font-medium transition-all duration-300 drop-shadow opacity-80 hover:opacity-100 rounded-md border border-white border-opacity-20"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
