...
const AuthorItem = ({image,  author, description, link}: AuthorItemProps) => {
  ...
  return (
    <div className='mx-2 max-w-full flex flex-col lg:flex-row font-neue-display mb-12'>
        <Image className='mb-2 object-cover saturate-0 rounded-md' src={image} alt={author} width={400} height={400}/>
