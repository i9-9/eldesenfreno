...
const Bio = () => {
  return (
    <div className='flex flex-col px-2 ml-24 '>
        ...
        <div>
          <p className='text-sm font-neue-display leading-6 italic -tracking-wide mt-2 p-2 text-xs bg-[#121212] hover:bg-gray-400 transition-all duration-700 drop-shadow	 opacity-80 rounded-md'>
