...
const Bio = () => {
  return (
    <div className='flex flex-col px-2 ml-24 '>
        ...
        <div>
          <p className=' text-white text-xs font-neue-display leading-6 italic -tracking-wide mt-2 p-2 transition-all duration-700 drop-shadow	 opacity-80 rounded-md'>
        ...
        <div className="mt-8 px-2">
          <a 
            ...
            className="inline-flex items-center gap-2 p-3 bg-[#2C2C2C] hover:bg-gray-400 text-white text-xs font-neue-display font-medium transition-all duration-700 drop-shadow opacity-80 hover:opacity-100 rounded-md border border-[#666666] border-opacity-20"
          >
            <svg 
              className="w-4 h-4" 
              fill="currentColor" 
